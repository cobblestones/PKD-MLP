    ...
    for (motion_input, motion_target) in pbar:
        ...
        for idx in range(num_step):
            with torch.no_grad():
                ...
                output, PosteriorKnowledge = model(motion_input_)
                output = output+PosteriorKnowledge
        ...
        pred_rot = motion_pred.clone().reshape(b, l_out, config.node_num, 3)
...
if __name__ == "__main__":
    ...
    config.motion_mlp.distill_layer_num = 12

    for key in config:
        print(key, ":", config[key])
    model = Model(config)

    # pth_name = 'train_H36M_AblationStudy_FixedMaskErrorSelfCorrectionModel_bs256_num48_common_branch_weight0.2_errorpercepnum8_2023_08_22_14H_58M_30S_Sel/iter-32000-AverageEror_9.627_21.781_46.543_57.394_75.491_89.560_101.427_109.395______Sel.pth'
    pth_name = 'ErrorCorrectionBest/iter-31000-AverageEror_9.676_21.714_46.277_57.094_75.263_89.415_101.204_109.088.pth'
